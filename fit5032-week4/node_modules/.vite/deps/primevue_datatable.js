import {
  Base,
  script
} from "./chunk-J4UNUNIP.js";
import {
  FilterMatchMode,
  FilterOperator,
  FilterService,
  PrimeVueService
} from "./chunk-OJORL6CV.js";
import {
  $t,
  At,
  B,
    ...
    onSpaceKey: function onSpaceKey2(event, rowData, rowIndex2, slotProps) {
      ...
      if (event.shiftKey && this.selection !== null) {
        ...
        if (this.selection.length > 0) {
          ...
          firstSelectedRowIndex = C2(this.selection[0], data19);
          lastSelectedRowIndex = C2(this.selection[this.selection.length - 1], data19);
          index = rowIndex2 <= firstSelectedRowIndex ? lastSelectedRowIndex : firstSelectedRowIndex;
        } else {
          index = C2(this.selection, data19);
        }
  ...
  computed: {
    ...
    allRowsSelected: function allRowsSelected() {
      ...
      if (this.selectAll !== null) {
        ...
        return s2(val) && this.selection && Array.isArray(this.selection) && val.every(function(v3) {

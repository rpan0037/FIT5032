...
const reasonMessage = computed(() => {
  return formData.value.reason.toLowerCase().includes('friend') ? 'Great to have a friend' : ''
})
</script>
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="suburb" v-model.trim="formData.suburb" />
          </div>
